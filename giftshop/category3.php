...
<html>
   ...
   <body>
    ...
    <div class="gradients">
    <center><h2 style="color:white;">Home Decor</h2></center>
    	<?php
    		    ...
    		    <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
    	          <div class="card ">
	    			...
	    			<div class="card-content card_color black-text">
	    				<span class="card-title1 activator grey-text text-darken-4"> <b> <?php echo $row["name"];?></b><i class="material-icons right">more_vert</i></span>
