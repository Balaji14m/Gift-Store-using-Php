...
<html>
   ...
   <body>
    ...
    <div class="gradients">
    <center><h2 style="color:white;">Men Accessories</h2></center>
    	<?php
    	...
    	?>
    		 <div class="col s12 l3">   
    		    <form method="post" action="shopping_cart.php?action=add&id=<?php echo $row["id"];?>">
    	          <div class="card ">
    	          	<div class="card-images waves-effect waves-block waves-light">
	    				<img class="activator responsive-img" src="images/men/<?php echo $row["img"];?>"/><br/>
	    			</div>
              ...
              <input type="hidden" name="hidden_category" value="men">
